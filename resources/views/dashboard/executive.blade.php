        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="mapAI"
                            class="leaflet-map d-flex align-items-center justify-content-center text-center"></div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div>
            <!-- end col -->
        ...
        $(document).ready(function() {
            ...
            if (dataArea) {
                ...
                $.each(dataArea, function(index, value) {
                    ...
                    const longtitude = value.retail_data != undefined ? value.retail_data.location
                        .longtitude :
                    ...
                    if (value.potential_area_data != undefined) {
                        ...
                        $.each(value.potential_area_data.monthly, function(indexPotentialArea,
                            potentialArea) {
