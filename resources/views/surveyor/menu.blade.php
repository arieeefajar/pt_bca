        ...
        <div class="col-xxl-8">
            <div class="row">
                            ...
                            <a href="{{ route('formPesaing.index', ['api_id' => $form_pesaing[0]['api_id']]) }}">
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-soft-danger text-info rounded-2 fs-2 mt-2">
                ...
                @elseif ($kategoriToko == 'kios' || $kategoriToko == 'master_dealer' || $kategoriToko == 'dealer')
                    ...
                    {{-- kuisioner kekuatan kelemahan pesaing --}}
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    <h4 class="fs-4 flex-grow-1 mb-0">Kuisioner Kekuatan dan Kelemahan
                                                        Pesaing
                                                    </h4>
                                                </div>
                                            </div>
                                ...
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden ms-3">
                                                <p class="text-uppercase fw-semibold text-muted text-truncate mb-3">
                                                    <b class="text-seccondary d-flex justify-content-end">
                            ...
                            <a href="{{ route('formPesaing.index', ['api_id' => $form_pesaing[0]['api_id']]) }}">
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-soft-danger text-info rounded-2 fs-2 mt-3">
                                                    <i class="ri-survey-line text-danger"></i>
                                                </span>
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden ms-3">
                                                <p class="text-uppercase fw-semibold text-muted text-truncate mb-0">
                                                    <b class="text-success d-flex justify-content-end">
                                                        <small> Data Sudah Diisikan </small>
                                                        <i class="bx bx-check"></i>
                                                    </b>
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    <h4 class="fs-4 flex-grow-1 mb-0 mt-3">Form Survey Pesaing</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
