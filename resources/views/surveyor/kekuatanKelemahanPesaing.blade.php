...
>>>>>>> f8c955435b653db20c28e88b2e37ad7bf0aae709
                    </div>
                    <div class="live-preview">
                        <div class="table-responsive">
                            <form id="form_body" action="{{ route('KekuatanDanKelemahanPesaing.create') }}" method="POST">
                                ...
                                <table class="table table-bordered align-middle table-nowrap mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> Kapasitas pesaing dalam menanggapi gerakan pihak lain (misalnya produk baru
                                        ...
                                        <tr>
                                            <td>Kemampuan pesaing dalam menyesuaikan diri dan merespon kondisi yang berubah
                                                di setiap bidang fungsional (misalnya menyesuaikan diri untuk bersaing dalam
                                                harga,
