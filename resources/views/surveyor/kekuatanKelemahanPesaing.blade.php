                        ...
                        <div class="table-responsive">
                            <form id="form_body" action="{{ route('KekuatanDanKelemahanPesaing.create') }}" method="POST">
                                ...
                                <table class="table table-bordered align-middle  mb-3">
                                    <thead class="table-warning">
                                        <tr>
                                            <th class="text-center bg-soft-primary" colspan=6>Riset dan Pengembangan (R &
                                                D)</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center">Pertanyaan</th>
                                ...
                                <table class="table table-bordered align-middle  mb-3">
                                    <thead class="table-warning">
                                        <tr>
                                            <th class="text-center bg-soft-primary" colspan=6>Kemampuan Inti dan
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="atur_lebar"> Kemampuan pesaing mengukur konsistensi dari strateginya
                                            </td>
                                            <td align="center">
                                        ...
                                        <tr>
                                            <td class="atur_lebar"> Kapasitas pesaing dalam menanggapi gerakan pihak lain
                                        ...
                                        <tr>
                                            <td class="atur_lebar">Kemampuan pesaing dalam menyesuaikan diri dan merespon
                                        ...
                                        <tr>
                                            <td class="atur_lebar">Kemampuan pesaing untuk bertahan dari perang persaingan
                                                yang berkepanjangan,
