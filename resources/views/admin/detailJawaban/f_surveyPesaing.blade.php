                            ...
                            <div class="tab-content text-muted">
                                <div class="tab-pane fade show active" id="perbandingan-produk" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        @endforeach --}}
                                                {{-- </select> --}}
                                                <textarea class="form-control" required name="deskripsi_produk" id="" cols="30" rows="5" readonly>{{ $data['answer'][0] }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {{-- <div class="mb-3"> --}}
                                ...
                                <div class="tab-pane fade" id="keunggulan-kompetitif" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="content col">
                                            ...
                                            required> --}}
                                            <textarea class="form-control" name="keunggulan_pesaing" id="" cols="30" rows="5" required readonly>{{ $data['answer'][2] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="aktivitas-pemasaran-pesaing" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="content col">
                                            ...
                                            required> --}}
                                            <textarea class="form-control" name="pemasaran_pesaing" id="" cols="30" rows="5" required readonly>{{ $data['answer'][3] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
