                                ...
                                <div>
                                    <button type="button" class="btn btn-warning add-btn" data-bs-toggle="modal"
                                        id="create-btn" data-bs-target="#modalTambah"><i
                                            class="ri-add-line align-bottom me-1"></i> Tambah Posisi</button>
                                </div>
                            </div>
                            <div class="col-sm">
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center" data-sort="customer_name">Nama Posisi</th>
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('superAdmin.indexposisi.create') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="customername-field" class="form-label">Nama Posisi</label>
                            <input type="text" id="customername-field" name="nama" class="form-control"
                                placeholder="Masukan Nama Posisi..." required />
                        </div>
                    </div>
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('superAdmin.indexposisi.update') }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    <script>
        ...
        const deleteData = (id) => {
            ...
            $('#confirm-delete-data').click(function(e) {
                e.preventDefault();
                window.location.href = `posisi/destroy/${id}`
            });
        }
    </script>
@endsection
