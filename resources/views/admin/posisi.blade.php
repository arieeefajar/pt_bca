                ...
                <div id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <button type="button" class="btn btn-warning add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> Tambah Posisi</button>
                            </div>
                        </div>
                        <div class="col-sm">
            ...
            <form>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="customername-field" class="form-control" placeholder="Masukan Nama Posisi..." required />
                    </div>
                </div>
