                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-left" data-sort="email">Pertanyaan</th>
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">{{ $data->pertanyaan }}</td>
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('detail-kuisioner/store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('detail-kuisioner/update') }}" method="POST">
                @csrf
                <div class="modal-body">

                    <div class="mb-3" id="modal-id" style="display: none;">
                        <label for="id-field" class="form-label">ID</label>
                        <input type="text" id="id-edit" class="form-control" placeholder="ID" readonly name="id" />
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="customername-field" class="form-label">Jenis Jawaban</label>
                        <div class="input-group">
                            <select class="form-select" id="jenis-jawaban-edit" name="jenis_jawaban" name="jenis_jawaban">
