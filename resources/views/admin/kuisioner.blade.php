                ...
                <div id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                {{-- add data --}}
                                <button type="button" class="btn btn-warning add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> Tambah Kuisioners</button>
                            </div>
                        </div>
                        <div class="col-sm">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge rounded-pill bg-success">{{ $data->status == 1 ? 'Ditampilkan' : 'Tidak Ditampilkan' }}</span>
                                    </td>
                                    <td class="text-center">

                                        {{-- edit data --}}
                                        <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal" onclick="showEdit({{ $data }})">Edit</button>

                                        {{-- delete data --}}
                                        <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" onclick="showDelete({{ $data->id }})">Remove</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <form action="{{ url('kuisioner/store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="customername-field" class="form-control" placeholder="Masukkan Nama Kuisioner" required name="nama_quisioner" />
                    </div>
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ url('kuisioner/update') }}" method="POST">
                @csrf
                <div class="modal-body">

                    <div class="mb-3" id="modal-id" style="display: none;">
                        <label for="id-field-edit" class="form-label">ID</label>
                        <input type="text" id="id-field-edit" name="id" class="form-control" placeholder="ID" readonly />
                    </div>

                    <div class="mb-3">
                        <label for="customername-field-edit" class="form-label">Nama Kuisioner</label>
                        <input type="text" id="customername-field-edit" class="form-control" placeholder="Masukkan Nama Kuisioner" name="nama_quisioner_edit" required />
                    </div>
