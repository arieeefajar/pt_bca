                ...
                <div id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                <button type="button" class="btn btn-warning add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#modalTambah"><i class="ri-add-line align-bottom me-1"></i> Tambah Jenis Kuisioner</button>
                            </div>
                        </div>
                        <div class="col-sm">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal" onclick="setEdit({{ $data }})">Edit</button>
                                        <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" onclick="deleteData({{ $data->id }})">Remove</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <form action="{{ url('jenis-kuisioner/store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="customername-field" class="form-control" placeholder="Jenis Kuisioner..." name="jenis_kuisioner" required />
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal" onclick="clearEdit()"></button>
            </div>
            <form action="{{ url('jenis-kuisioner/update') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="modal-id" style="display: none;">
                        ...
                        <input type="text" id="id-jenis-edit" name="id_jenis_kuisioner_edit" class="form-control" placeholder="ID" readonly />
                    </div>

                    <div class="mb-3">
                        <label for="jenis-kuisioner-update" class="form-label">Jenis Kuisioner</label>
                        <input type="text" id="jenis-kuisioner-update" class="form-control" placeholder="Jenis Kuisioner..." required name="jenis_kuisioner_edit" />
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal" onclick="clearEdit()">Close</button>
