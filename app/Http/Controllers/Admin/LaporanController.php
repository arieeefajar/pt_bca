    ...
    public function getPertanyaanKepuasan($category, $area)
    {
        ...
        try {
            ...
            if ($category == 'product') {
                ...
                return response()->json([
                    'Kepuasan' =>
                        (float) $dataAllKategory['perhitungan_index_aspek'][
                            'product'
                        ]['kepuasan'] *
                            100 .
                        '%',
                    'Kelengkapan informasi pada kemasan' => $information,
                    'Harga Produk dibanding dengan kompetitor' => $price_comparison,
                    'Keunggulan Varietas dibanding kompetitor' => $variety_previlege,
                    'Tampilan kemasan produk' => $packaging_view,
                    'Kemudahan dalam memperoleh / membeli Produk' => $getting_easy,
                    'Kepuasan memilih produk' => $satisfaction,
                    'Tampilan gambar pada kemasan produk' => $image_view,
                ]);
            }
                    ...
                    'data' => [
                        'Kepuasan' =>
                            (float) $dataAllKategory['perhitungan_index_aspek'][
                                ...
                                100 .
                            '%',
                        'Kecukupan jumlah material promosi' => $material_amount,
                        'Kuantitas kegiatan promosi yang dilaksanakan oleh petugas' => $promotion_quantity,
                        'Kualitas kegiatan promosi yang dilaksanakan oleh petugas' => $promotion_quality,
                    ],
                ]);
            }
            ...
            if ($category == 'kualitas') {
                ...
                $dataTotalAllKategory =
                    $dataAllKategory['penilaian_pelanggan']['kualitas_produk'][
                        'total'
                    ];
                    ...
                    'data' => [
                        'Kepuasan' =>
                            (float) $dataAllKategory['perhitungan_index_aspek'][
                                ...
                                100 .
                            '%',
                        'Kemurnian fisik benih produk sesuai dengan standart mutu' => $seed_purity,
                        'Vigor benih produk pada saat dipersemaian' => $vigor,
                        'Daya tumbuh benih produk, sesuai dengan standart mutu' => $growing_power,
                        'Kemurnian genetik sesuai dengan standart mutu' => $genetic_purity,
                        'Ketahanan hama dan penyakit produk' => $pest_resistance,
                        'Kesesuaian gambar produk dengan hasil panen' => $suitablelity_image_result,
                        'Kesesuaian hasil panen terhadap permintaan pasar' => $suitablelity_result_request,
                        'Kepuasan hasil panen produk' => $satisfaction_result,
                    ],
                ]);
            }
            ...
            if ($category == 'layanan') {
                ...
                $dataTotalAllKategory =
                    $dataAllKategory['penilaian_pelanggan'][
                    ...
                    'data' => [
                        'Kepuasan' =>
                            (float) $dataAllKategory['perhitungan_index_aspek'][
                                ...
                                100 .
                            '%',
                        'Kemampuan teknis budidaya petugas lapang' => $technical_ability,
                        'Intensitas kunjungan petugas lapang' => $visit_intensity,
                        'Intensitas interaksi dan komunikasi petugas lapang' => $communication_intensity,
                        'Kecakapan dan kredibilitas (dapat dipercaya) petugas lapang' => $skill_credibility,
                        'Pengaruh keberadaan petugas lapang' => $influence_of_officer,
                        'Kemampuan teknis komunikasi petugas lapang' => $communication_skill,
                    ],
                ]);
            }
                    ...
                    'data' => [
                        'Kepuasan' =>
                            (float) $dataAllKategory['perhitungan_index_aspek'][
                                ...
                                100 .
                            '%',
                        'Kecepatan verifikasi komplain pelanggan' => $verification_speed,
                        'Kecepatan penyelesaian komplain pelanggan' => $completion_speed,
                        'Penanganan komplain pelanggan' => $handling,
                    ],
                ]);
            }
        } catch (\Throwable $th) {
        ...
        try {
            ...
            if ($category == 'product') {
                ...
                return response()->json([
                    ...
                    'Kedudukan produk pesaing (dari sudut pandang pengguna) di setiap segmen pasar' => $position_pov,
                    'Luas dan dalamnya lini produk pesaing' => $deep,
                ]);
            }
            if ($category == 'distribusi') {
                ...
                return response()->json([
                    'Kepuasan' => (float) $dataAllKategory['perhitungan_index_aspek']['product']['kepuasan'] * 100 . '%',
                    'Kualitas saluran distribusi pesaing' => $distribution_line,
                    'Kekuatan hubungan saluran distribusi yang dimiliki pesaing' => $line_power,
                    'Kemampuan pesaing untuk melayani saluran distribusi' => $line_ability,
                ]);
            }
            if ($category == 'pemasaran') {
                ...
                return response()->json([
                    'Kepuasan' => (float) $dataAllKategory['perhitungan_index_aspek']['product']['kepuasan'] * 100 . '%',
                    'Keterampilan pesaing pada masing-masing aspek bauran pemasaran' => $marketing_skill,
                    'Keterampilan pesaing dalam pengembangan produk baru' => $dev_skill,
                ]);
            }
            if ($category == 'operasional') {
                ...
                return response()->json([
                    ...
                    'Kecanggihan teknologi dari fasilitas dan peralatan yang dimiliki pesaing' => $advanced_tech,
                    'Fleksibilitas fasilitas dan peralatan yang dimiliki pesaing' => $fasility_flexibility,
                    'Keterampilan pesaing dalam penambahan kapasitas, pengendalian kualitas, penggunaan fasilitas, dan peralatan' => $scale_up_skill,
                    'Akses dan biaya bahan baku yang dialokasikan pesaing' => $material_cost,
                ]);
            }
            if ($category == 'riset') {
                $copyrights = [];
                ...
                return response()->json([
                    ...
                    'Paten dan hak cipta yang dimiliki pesaing' => $copyrights,
                    'Kemampuan internal perusahaan pesaing dalam proses riset dan pengembangan' => $rnd_ability,
                    'Keterampilan staf divisi riset dan pengembangan pesaing' => $staff_skill,
                    'Akses pesaing ke sumber-sumber eksternal perusahaan untuk penguatan riset dan pengembangan' => $resource_access,
                ]);
            }
            if ($category == 'keuangan') {
                ...
                return response()->json([
                    ...
                    'Arus kas pesaing' => $cash_flow,
                    'Kapasitas modal baru yang dimiliki pesaing untuk bisnis masa depan' => $capital_capacity,
                    'Kemampuan manajemen keuangan pesaing, termasuk negosiasi, mendapatkan modal, kredit, persediaan, serta piutang' => $trust_management,
                ]);
            }
            if ($category == 'organisasi') {
                ...
                return response()->json([
                    ...
                    'Keseragaman nilai dan kejelasan misi dan tujuan organisasi pesaing' => $vision_mission,
                    'Konsistensi struktur organisasi dengan strategi bisnis pesaing' => $consistency_organization_structure,
                ]);
            }
            if ($category == 'manajerial') {
                ...
                return response()->json([
                    ...
                    'Kualitas kepemimpinan CEO pesaing - kemampuan Direktur Utama untuk memotivasi' => $lead_quality,
                    'Kemampuan manajemen perusahaan pesaing untuk mengkoordinasi fungsi atau kelompok fungsi tertentu (misalnya koordinasi pengembangan produk dengan riset)' => $management_ability,
                ]);
            }
            if ($category == 'inti') {
                $functional_ability = [];
                ...
                return response()->json([
                    ...
                    'Kemampuan pesaing dalam bidang fungsional' => $functional_ability,
                    'Kemampuan pesaing mengukur konsistensi dari strateginya' => $measurement_ability,
                    'Kapasitas pesaing dalam menanggapi gerakan pihak lain (misalnya produk baru yang belum diperkenalkan, tetapi sudah siap untuk diluncurkan)' => $movement_response,
                    'Kemampuan pesaing dalam menyesuaikan diri dan merespon kondisi yang berubah di setiap bidang fungsional (misalnya menyesuaikan diri untuk bersaing dalam harga, mengelola lini produk yang lebih kompleks, menambah produk baru, bersaing dalam layanan, meningkatkan kegiatan pemasaran)' => $response_to_change,
                    'Kemampuan pesaing untuk bertahan dari perang persaingan yang berkepanjangan, yang mungkin akan menekan laba dan arus kas' => $competition_ability,
                ]);
            }
            if ($category == 'portofolio') {
                ...
                return response()->json([
                    ...
                    'Kemampuan pesaing untuk mendukung perubahan yang terencana dalam semua unit bisnisnya dalam bentuk sumber dana dan sumber daya lain' => $support_change,
                    'Kemampuan pesaing untuk melengkapi atau memperkokoh kekuatan unit bisnisnya' => $strengthening_ability,
                ]);
            }
            if ($category == 'lainnya') {
                $special_treatment = [];
                ...
                return response()->json([
                    ...
                    'Perlakuan khusus atau akses pesaing ke lembaga pemerintahan' => $special_treatment,
                ]);
            }
