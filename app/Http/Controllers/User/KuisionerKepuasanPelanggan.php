...
class KuisionerKepuasanPelanggan extends Controller
{
    public function index(Request $request, $api_id = null)
    {
        ...
        $k_pelanggan = DetailPenyimpanan::hasDetailPenyimpanan(
            $idPenyimpanan,
            'k_kepuasan'
        );
    ...
    public function store(Request $request)
    {
        ...
        $suitablelity_image_result = intval(
            $request->suitablelity_image_result
        );
        $suitablelity_result_request = intval(
            $request->suitablelity_result_request
        );
